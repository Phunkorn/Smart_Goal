...
class WorkLogParticipantService
{
     ...
     * แต่ทำงานเป็นทีม: ใครกดเริ่มแล้วตอบว่าอีกคน "มาทำด้วย" ทั้งคู่เริ่มพร้อมกัน และใครกดเสร็จ
     * ก็ปิดพร้อมกัน (RoutineAccountabilityService) ปฏิทินและรายงานแผนกนับเป็นงานชิ้นเดียว
     * (JointRoutineWork) ต่างจากผู้ร่วมงานของบันทึกรายวันที่เป็นเพียงการบอกว่า
     * งานชิ้นนั้นทำด้วยกันในรายการของเจ้าของคนเดียว
     *
     * @param  array<int, mixed>  $userIds
